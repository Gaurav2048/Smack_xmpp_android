package com.gunjan.xmpp.smack.smackxmpp_01.xmpp;
...
import com.gunjan.xmpp.smack.smackxmpp_01.Constants;
    ...
    public void connect() throws IOException,XMPPException,SmackException
    {
        ...
        chatManager.addIncomingListener(new IncomingChatMessageListener() {
            ...
            public void newIncomingMessage(EntityBareJid from, Message message, Chat chat) {
                ...
                {
                    List<com.gunjan.xmpp.smack.smackxmpp_01.model.chat> chats = chatModel.get(mApplicationContext).getChatsByJid(contactJid);
                    if( chats.size() == 0) {
                        Log.d(LOGTAG, contactJid + " is a new chat, adding them. With timestamp :" + Uti.getFormattedTime(System.currentTimeMillis()));
